...
public constructor(controllers: Controller[]) {
  ...
  this.initRunTimerErrorMiddleware();
}
...
private connectDatabase(): void {
  mongoose.connect('mongodb+srv://eduardadudavaz:57A9ptuzanrD89eY@cluster0.sjjshrq.mongodb.net/curso-javascript?retryWrites=true&w=majority', {
...
private initRunTimerErrorMiddleware() {
